...
use crate::{fork::environment, provider::{RpcUrl, ProviderBuilder}, ALCHEMY_FREE_TIER_CUPS, utils::{h160_to_b160, h256_to_b256}};
...
impl EvmOpts {
    ...
    pub fn local_evm_env(&self) -> revm::primitives::Env {
        revm::primitives::Env {
            ...
            cfg: CfgEnv {
                chain_id: rU256::from(self.env.chain_id.unwrap_or(Chain::Mainnet as u64)),
